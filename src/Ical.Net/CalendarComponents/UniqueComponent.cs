...
public class UniqueComponent : CalendarComponent, IUniqueComponent, IComparable<UniqueComponent>
{
    ...
    private void EnsureProperties()
    {
        ...
        if (DtStamp == null)
        {
            ...
            DtStamp = new CalDateTime(utcNow, "UTC", true);
        }
    }
    ...
    {
        if (obj is not RecurringComponent recurringComponent || recurringComponent == this) return base.Equals(obj);
        if (Uid != null)
        {
            return Uid.Equals(recurringComponent.Uid);
        }
        return Uid == recurringComponent.Uid;
    }
