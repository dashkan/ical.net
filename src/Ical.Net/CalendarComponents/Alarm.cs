...
public sealed class Alarm : CalendarComponent
{
    ...
    private IList<AlarmOccurrence> Occurrences { get; set; }
    ...
    public IList<AlarmOccurrence> GetOccurrences(IRecurringComponent rc, IDateTime fromDate, IDateTime toDate)
    {
        ...
        if (Trigger.IsRelative)
        {
            ...
            foreach (var o in rc.GetOccurrences(fromDate, toDate))
            {
                ...
                Debug.Assert(Trigger.Duration != null, "Trigger.Duration != null");
    ...
    /// <param name="end">The latest date/time to poll triggered alarms for.</param>
