...
public sealed class CalDateTime : EncodableDataType, IDateTime
{
    ...
    public CalDateTime(int year, int month, int day, int hour, int minute, int second, int ms = 0)
    {
        Initialize(year, month, day, hour, minute, second, ms);
        HasTime = true;
    }
    
    public CalDateTime(int year, int month, int day, int hour, int minute, int second, int ms, string tzId)
    {
        Initialize(year, month, day, hour, minute, second, ms, tzId);
        HasTime = true;
    }
    ...
    private DateTime CoerceDateTime(int year, int month, int day, int hour, int minute, int second, int ms, DateTimeKind kind)
    {
        ...
        // TODO: should we have a parsing setting that will throw an exception
