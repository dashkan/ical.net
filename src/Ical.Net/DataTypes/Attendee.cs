...
public sealed class Attendee : EncodableDataType
{
    ...
    {
        get => _members ??= new List<string>(Parameters.GetMany("MEMBER"));
        set
        {
    ...
    {
        get => _delegatedTo ??= new List<string>(Parameters.GetMany("DELEGATED-TO"));
        set
        {
            if (value == null)
            {
    ...
    {
        get => _delegatedFrom ??= new List<string>(Parameters.GetMany("DELEGATED-FROM"));
        set
        {
            if (value == null)
            {
    ...
    private bool Equals(Attendee other) => Equals(SentBy, other.SentBy)
