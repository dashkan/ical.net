...
public class TodoTest
{
    ...
    public void Todo7_1()
    {
        ...
        {
            new CalDateTime(2006, 7, 28, 9, 0, 0, TzId),
            new CalDateTime(2006, 8, 4, 9, 0, 0, TzId),
            new CalDateTime(2006, 9, 1, 9, 0, 0, TzId),
            new CalDateTime(2006, 10, 6, 9, 0, 0, TzId),
            new CalDateTime(2006, 11, 3, 9, 0, 0, TzId),
            new CalDateTime(2006, 12, 1, 9, 0, 0, TzId),
            new CalDateTime(2007, 1, 5, 9, 0, 0, TzId),
            new CalDateTime(2007, 2, 2, 9, 0, 0, TzId),
            new CalDateTime(2007, 3, 2, 9, 0, 0, TzId),
            new CalDateTime(2007, 4, 6, 9, 0, 0, TzId)
        };
        ...
        // TODO: Count is not properly restricting recurrences to 10.
