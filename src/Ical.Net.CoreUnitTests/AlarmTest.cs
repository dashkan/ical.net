...
public class AlarmTest
{
    ...
    public void Alarm1()
    {
        ...
        TestAlarm(content, dateTimes, new CalDateTime(2006, 7, 1, Tzid), new CalDateTime(2006, 9, 1, Tzid));
    }
    ...
    public void Alarm3()
    {
        ...
        TestAlarm(content, dateTimes, new CalDateTime(1997, 1, 1, Tzid), new CalDateTime(2000, 12, 31, Tzid));
    }
    ...
    public void Alarm5()
    {
        ...
        TestAlarm(content, dateTimes, new CalDateTime(1997, 7, 1, Tzid), new CalDateTime(2000, 12, 31, Tzid));
    }
