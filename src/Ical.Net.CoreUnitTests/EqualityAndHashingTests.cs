...
{
    private const string SomeTz = "America/Los_Angeles";
    ...
    public static IEnumerable<ITestCaseData> CalDateTime_TestCases()
    {
        ...
        var nowCalDtWithTz = new CalDateTime(_nowTime, SomeTz);
        yield return new TestCaseData(nowCalDtWithTz, new CalDateTime(_nowTime, SomeTz)).SetName("Now, with time zone");
    }
    ...
    private static RecurrencePattern GetSimpleRecurrencePattern() => new(FrequencyType.Daily)
    {
        Count = 5
    };
    ...
    {
        var rruleA = new RecurrencePattern(FrequencyType.Daily)
        {
            Count = 5
        };
        ...
        var rruleB = new RecurrencePattern(FrequencyType.Daily)
        {
            Count = 5
        };
    ...
    public void PeriodListTests()
    {
        var startTimesA = new List<DateTime>
            {
                new(2017, 03, 02, 06, 00, 00),
                new(2017, 03, 03, 06, 00, 00),
                new(2017, 03, 06, 06, 00, 00),
                new(2017, 03, 07, 06, 00, 00),
                new(2017, 03, 08, 06, 00, 00),
                new(2017, 03, 09, 06, 00, 00),
                new(2017, 03, 10, 06, 00, 00),
                new(2017, 03, 13, 06, 00, 00),
                new(2017, 03, 14, 06, 00, 00),
                new(2017, 03, 17, 06, 00, 00),
                new(2017, 03, 20, 06, 00, 00),
                new(2017, 03, 21, 06, 00, 00),
                new(2017, 03, 22, 06, 00, 00),
                new(2017, 03, 23, 06, 00, 00),
                new(2017, 03, 24, 06, 00, 00),
                new(2017, 03, 27, 06, 00, 00),
                new(2017, 03, 28, 06, 00, 00),
                new(2017, 03, 29, 06, 00, 00),
                new(2017, 03, 30, 06, 00, 00),
                new(2017, 03, 31, 06, 00, 00),
                new(2017, 04, 03, 06, 00, 00),
                new(2017, 04, 05, 06, 00, 00),
                new(2017, 04, 06, 06, 00, 00),
                new(2017, 04, 07, 06, 00, 00),
                new(2017, 04, 10, 06, 00, 00),
                new(2017, 04, 11, 06, 00, 00),
                new(2017, 04, 12, 06, 00, 00),
                new(2017, 04, 13, 06, 00, 00),
                new(2017, 04, 17, 06, 00, 00),
                new(2017, 04, 18, 06, 00, 00),
                new(2017, 04, 19, 06, 00, 00),
                new(2017, 04, 20, 06, 00, 00),
                new(2017, 04, 21, 06, 00, 00),
                new(2017, 04, 24, 06, 00, 00),
                new(2017, 04, 25, 06, 00, 00),
                new(2017, 04, 27, 06, 00, 00),
                new(2017, 04, 28, 06, 00, 00),
                new(2017, 05, 01, 06, 00, 00),
            }
